      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 32px' }}>
        ...
        <div style={{ fontSize: 15, color: 'var(--ts-fg-secondary)', lineHeight: 1.85, fontFamily: 'var(--font-sans)' }}>
          ...
          <p style={{ marginBottom: 24 }}>
            By accessing or using TaxSentry, a financial compliance infrastructure product operated by Ripple Nexus, you agree to be bound by this Privacy Policy. TaxSentry is architected exclusively for UAE Free Zone Qualifying Persons navigating the 9% corporate tax regime. If you do not agree with any part of these terms, you must not use our services.
          </p>
          ...
          <p style={{ marginBottom: 24 }}>
            The Privacy Policy governs how Ripple Nexus accesses, categorizes, and audits your financial transactions (including Qualifying and Non-Qualifying Income thresholds). We act solely as a data processor under UAE law, while you retain all rights as the data controller.
          </p>
          ...
          <p style={{ marginBottom: 24 }}>
            Access to TaxSentry is granted on a subscription basis. Ripple Nexus reserves the right to modify, suspend, or terminate access to the platform in the event of a breach of this Privacy Policy, failure to process payments, or instances of suspected unauthorized access.
          </p>

          <h2 style={{ fontSize: 20, fontWeight: 800, color: 'var(--ts-fg-primary)', marginTop: 48, marginBottom: 16 }}>5. Changes to the Document</h2>
          <p style={{ marginBottom: 24 }}>
            Ripple Nexus reserves the right to update this Privacy Policy at any time. Significant changes will be communicated to your administrative account holders. Continued use of TaxSentry following any changes indicates your acceptance of the updated document.
          </p>
