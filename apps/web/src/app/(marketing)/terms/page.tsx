      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 32px' }}>
        ...
        <div style={{ fontSize: 15, color: 'var(--ts-fg-secondary)', lineHeight: 1.85, fontFamily: 'var(--font-sans)' }}>
          ...
          <p style={{ marginBottom: 24 }}>
            By accessing or using TaxSentry, a financial compliance infrastructure product operated by Ripple Nexus, you agree to be bound by this Terms of Service. TaxSentry is architected exclusively for UAE Free Zone Qualifying Persons navigating the 9% corporate tax regime. If you do not agree with any part of these terms, you must not use our services.
          </p>
          ...
          <p style={{ marginBottom: 24 }}>
            The Terms of Service governs how Ripple Nexus accesses, categorizes, and audits your financial transactions (including Qualifying and Non-Qualifying Income thresholds). We act solely as a data processor under UAE law, while you retain all rights as the data controller.
          </p>
          ...
          <p style={{ marginBottom: 24 }}>
            Access to TaxSentry is granted on a subscription basis. Ripple Nexus reserves the right to modify, suspend, or terminate access to the platform in the event of a breach of this Terms of Service, failure to process payments, or instances of suspected unauthorized access.
          </p>

          <h2 style={{ fontSize: 20, fontWeight: 800, color: 'var(--ts-fg-primary)', marginTop: 48, marginBottom: 16 }}>5. Changes to the Document</h2>
          <p style={{ marginBottom: 24 }}>
            Ripple Nexus reserves the right to update this Terms of Service at any time. Significant changes will be communicated to your administrative account holders. Continued use of TaxSentry following any changes indicates your acceptance of the updated document.
          </p>
          ...
          <div style={{ marginTop: 80, padding: 32, background: 'var(--ts-bg-muted)', borderRadius: 16, border: '1px solid var(--ts-border)' }}>
            ...
            <p style={{ fontSize: 14, margin: 0 }}>
              If you have any questions regarding this Terms of Service, please contact Ripple Nexus legal counsel at legal@theripplenexus.com.
            </p>
          </div>
        </div>
      </div>
